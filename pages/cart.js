...
async function goToStripe() {
 const response = await axios.post('/api/checkout', {
  ...
  if (response.data.url){
    //Because the information where it is going is outside of our React application, the stripe thing to be specific
  ...
  {products.map(product => (
   ...
   <tr>
    ...
    {!!cartProducts?.length  && (
     ...
     <Button black block onClick={goToStripe}>Continue to Payment</Button>
